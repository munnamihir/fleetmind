    ...
    <section className="fleetCommandOperations">
      ...
      {workspace ===
        ...
        <div className="fleetOpsWorkspace">
          ...
          <div className="fleetOpsTwoColumn">
            <article className="panel fleetOpsPanel">
              ...
              <div className="fleetOpsQueueGroups">
                {topQueueGroups.map(
                  group => (
                    <div
                      key={
          ...
          {explainabilityDetail && (
            <div className="fleetOpsTwoColumn">
              <article className="panel fleetOpsPanel">
                ...
                <div className="fleetOpsEvidenceLayers">
                  {explainabilityDetail
                    .evidenceInventory
                    .layers.map(
                      layer => (
              ...
              <article className="panel fleetOpsPanel">
                ...
                <div className="fleetOpsLineagePath">
                  {explainabilityDetail
                    .lineage
                    .lineagePath.map(
                      (
      ...
      {workspace ===
        ...
        <div className="fleetOpsWorkspace">
          <div className="fleetOpsOperatorBar">
            ...
            <small>
              Evaluation may preview without writing. Materialization requires
              an explicit action.
            </small>
          </div>
          ...
          <div className="fleetOpsGuardrail">
            ...
            <div>
              ...
              <span>
                PROPOSED → ACKNOWLEDGED → APPROVAL REQUIRED → APPROVED →
                EXECUTION READY → EXECUTED. No lifecycle state performs a
                physical maintenance or vehicle command.
              </span>
            </div>
          </div>
        </div>
